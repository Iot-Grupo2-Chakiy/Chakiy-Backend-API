package com.iot.error404.chakiy.iam.infrastructure.authorization.sfs.configuration;

import com.iot.error404.chakiy.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.iot.error404.chakiy.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.iot.error404.chakiy.iam.infrastructure.tokens.jwt.BearerTokenService;
    ...
    http.csrf(csrfConfigurer -> csrfConfigurer.disable())
        ...
        .authorizeHttpRequests(
            authorizeRequests -> authorizeRequests.requestMatchers(
                ...
                "/swagger-ui/**", "/swagger-resources/**", "/webjars/**","/authentication/**")
                .permitAll()
                .anyRequest()
                .authenticated());
